...
def main(path = None, in_file = None, data_file = None, variable = None, reduce_size = False):
    ...
    if data_obj.success == False:
        ...
        compiler = XYZ(data_obj, user_options) #moving and compiling xyz files
...
if __name__ == "__main__":
    ...
    result_dir = "/users/jamespittard/documents/Culham/lammpsdepo/lammps/examples/diamond_graphene"
    main(path = result_dir, in_file="%s/in.min.dia_graph"%result_dir, data_file = "%s/data.graphite_sheet"%result_dir,
        reduce_size= False)
